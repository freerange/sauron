...
On ubuntu:
    ...
    Download the latest deb from elasticsearch.org:

        wget https://github.com/downloads/elasticsearch/elasticsearch/elasticsearch-0.19.2.deb

    Install the downloaded deb

        sudo dpkg -i elasticsearch-0.19.2.deb
